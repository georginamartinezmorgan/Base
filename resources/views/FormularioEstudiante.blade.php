...
@section('titulo','Formulario Estudiante')
...
<input type="text" class="form-control" name="apellido" id="apellido" placeholder="Apellido DEL EStudiante">
</div>
...
<input type="number" class="form-control" name="nota" id="nota" placeholder="1-100">
</div>
...
<input type="number" class="form-control" name="cuenta" id="cuenta" placeholder="###########">
</div>
